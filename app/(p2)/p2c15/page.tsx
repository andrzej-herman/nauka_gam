                ...
                <Card>
                  <CardContent className="flex aspect-video items-center justify-center p-6">
                    <div className="text-center">
                      ...
                      <div className="mb-1">Ćwiczenie nr 15</div>
                      <div className="mb-5">Utwór nr 1</div>
                      <audio controls controlsList="nodownload">
                        <source src="/mp3/p2/_15/_15_01.mp3" type="audio/mp3"/>
                      </audio>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardContent className="flex aspect-video items-center justify-center p-6">
                    <div className="text-center">
                      ...
                      <audio controls controlsList="nodownload">
                        <source src="/mp3/p2/_15/_15_02.mp3" type="audio/mp3"/>
                      </audio>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardContent className="flex aspect-video items-center justify-center p-6">
                    <div className="text-center">
                      ...
                      <audio controls controlsList="nodownload">
                        <source src="/mp3/p2/_15/_15_03.mp3" type="audio/mp3"/>
                      </audio>
                    </div>
                  </CardContent>
                </Card>
